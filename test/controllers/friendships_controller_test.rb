...
class FriendshipsControllerTest < ActionController::TestCase
  ...
  test "should create friendship" do
    assert_difference('Friendship.count') do
      post :create, friendship: { accept: @friendship.accept, friend_id: @friendship.friend_id, user_id: @friendship.user_id }
    end
  ...
  test "should update friendship" do
    patch :update, id: @friendship, friendship: { accept: @friendship.accept, friend_id: @friendship.friend_id, user_id: @friendship.user_id }
    assert_redirected_to friendship_path(assigns(:friendship))
  end
