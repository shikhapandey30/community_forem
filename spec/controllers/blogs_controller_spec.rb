...
RSpec.describe BlogsController, type: :controller do
  ...
  let(:valid_attributes) {
    { description: 'updated_last_name', name: "Topic", user_id: 1 }
  }

  let(:invalid_attributes) {
    { description: 'updated_last_name', name: "Topic", user_id: 'ss' }
  }
  ...
  describe "PUT #update" do
    context "with valid params" do
      let(:new_attributes) {
        { description: 'new description', name: "new group", user_id: 1 }
      }
